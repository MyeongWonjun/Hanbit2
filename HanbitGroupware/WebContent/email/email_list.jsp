            				...
            				<tfoot>
                              ...
                              <ol class="paging">
                                 ...
                                 <c:choose>
                                    ...
                                    <c:otherwise>
                                       <li><a
                                          href="/HanbitGroupware/Email?type=getEmailList&email_addr=${info.email_addr}&cPage=${pvo.beginPage-pvo.pagePerBlock }">이전으로</a></li>
                                    </c:otherwise>
                                 </c:choose>
                                 ...
                                 <c:forEach var="k" begin="${pvo.beginPage}"
                                    ...
                                    <c:choose>
                                       ...
                                       <c:otherwise>
                                          <li><a
                                             href="/HanbitGroupware/Email?type=getEmailList&email_addr=${info.email_addr}&cPage=${k}">${k}</a></li>
                                       </c:otherwise>
                                    </c:choose>
                                 </c:forEach>
                                 <c:choose>
                                    ...
                                    <c:otherwise>
                                       <li><a href="/HanbitGroupware/Email?type=getEmailList&email_addr=${info.email_addr}&cPage=${pvo.beginPage+pvo.pagePerBlock }">다음으로</a>
                                       </li>
                                    </c:otherwise>
                                 </c:choose>
                              </ol>
