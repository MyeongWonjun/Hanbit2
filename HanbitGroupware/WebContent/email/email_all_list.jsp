...
<script type="text/javascript">
	...
	function answer_go(f) {
		f.action="/HanbitGroupware/Email?type=getAnswer&email_addr=<%=email_addr2%>";
		f.submit();
	}
      ...
      <tbody>
         <tr>
            ...
            <td  style="vertical-align: top;" >
            	...
            	<thead>
            		<tr>
            			<th colspan="2" width="990px" align="left">
            				<p>
            				<span id="text">
							...
							<div>
								<span id="chk1">
									<input type="checkbox" id="chk_all" name="ddd" class="dddd"/>
								</span>
								<sapn id="btn4">
									전체선택
            			...
            			<table>
            				<tbody>
            					...
            					<tr>
            						...
            						<hr/></td>
            						<td width="225px">from : ${k.sender_addr}<hr/></td>
            				...
            				<tfoot>
                              ...
                              <ol class="paging">
                                 ...
                                 <c:choose>
                                    ...
                                    <c:otherwise>
                                       <li><a
                                          href="/HanbitGroupware/Email?type=getAllEmailList&email_addr=${info.email_addr}&cPage=${pvo.beginPage-pvo.pagePerBlock }">이전으로</a></li>
                                    </c:otherwise>
                                 </c:choose>
                                 ...
                                 <c:forEach var="k" begin="${pvo.beginPage}"
                                    ...
                                    <c:choose>
                                       ...
                                       <c:otherwise>
                                          <li><a
                                             href="/HanbitGroupware/Email?type=getAllEmailList&email_addr=${info.email_addr}&cPage=${k}">${k}</a></li>
                                       </c:otherwise>
                                    </c:choose>
                                 </c:forEach>
                                 <c:choose>
                                    ...
                                    <c:otherwise>
                                       <li><a href="/HanbitGroupware/Email?type=getAllEmailList&email_addr=${info.email_addr}&cPage=${pvo.beginPage+pvo.pagePerBlock }">다음으로</a>
                                       </li>
                                    </c:otherwise>
                                 </c:choose>
                              </ol>
