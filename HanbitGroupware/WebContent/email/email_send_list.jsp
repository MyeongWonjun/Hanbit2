...
<script type="text/javascript">
	function write_go(f) {
		f.action="email/email_write.jsp?email_addr=<%=email_addr%>";
		f.submit();
	}
	function write_goME(f) {
		f.action="email/email_writeME.jsp?email_addr=<%=email_addr%>";
		f.submit();
	}
</script>
</head>
            			...
            			<table>
            				<tbody>
            					...
            					<tr>
            						...
            						<hr/></td>
            						<td width="175px">from : ${k.sender_addr}<hr/></td>
            						
            						<td width="175px">to : ${k.email_addr}<hr/></td>

            						<td width="350px"><a href="/HanbitGroupware/Email?type=email_oneList&idx=${k.idx}">${k.subject}</a><hr/></td>
