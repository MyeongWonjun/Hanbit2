...
public class SetInsertCommand implements Command{
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) {
		...
		Dao dao = new Dao();
         ...
         vo_employees.setId(request.getParameter("id"));
         vo_employees.setPwd(request.getParameter("pwd"));
